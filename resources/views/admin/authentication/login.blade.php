        ...
        <div class="auth-inner row m-0">
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    ...
                    <form class="auth-login-form mt-2" action="{{route('admin.auth.post.login')}}" method="POST"> @csrf
                        <div class="mb-1">
                        ...
                        <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="remember-me" name="remember" type="checkbox" tabindex="3"/>
                    ...
                    <p class="text-center mt-2">
                        ...
                        <a href="{{route('admin.auth.register')}}"><span>&nbsp;Create an account</span></a>
                    </p>
