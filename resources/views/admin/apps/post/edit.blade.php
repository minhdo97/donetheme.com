            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form" action="{{route('admin.posts.update',['post'=>$post->id])}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <div class="">
                                            <img src="{{$post->getFirstMediaUrl('image')}}" width="100" alt="">
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div id="full-wrapper">
                                            <div id="full-container">
                                                <div class="editor">{!! old('body',$post->body) !!}</div>
