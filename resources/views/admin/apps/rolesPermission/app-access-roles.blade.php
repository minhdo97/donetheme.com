...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-1 pt-25">
                            <div class="role-heading">
                                ...
                                <a href="javascript:;" data-id="{{$role->id}}" class="role-edit-modal" data-bs-toggle="modal"
    ...
    <!-- table -->
    @include('admin/content/_partials/_modals/modal-edit-role')
    @include('admin/content/_partials/_modals/modal-add-role',['permissions'=>$permissions])
@endsection
