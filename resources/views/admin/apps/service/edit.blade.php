            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form" action="{{route('admin.services.update',['service'=>$service->id])}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <div class="">
                                            <img src="{{$service->getFirstMediaUrl('image')}}" width="100" alt="">
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div id="full-wrapper">
                                            <div id="full-container">
                                                <div class="editor">{!! old('body',$service->body) !!}</div>
                                                <textarea style="display: none" id="bodyHtml"
                                                          name="body">{!! old('body',$service->body) !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
