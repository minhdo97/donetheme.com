            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form" action="{{route('admin.projects.update',['project'=>$project->id])}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <div class="">
                                            <img src="{{$project->getFirstMediaUrl('image')}}" width="100" alt="">
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select class="select2 form-select" name="category_id" id="select2-category_id">
                                            @foreach($categories as $category)
                                                <option @if($project->project_category_id == $category->id)  selected
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div id="full-wrapper">
                                            <div id="full-container">
                                                <div class="editor">{!! old('body',$project->body) !!}</div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        >{!! old('seo_description',$project->seo_description) !!}</textarea>
                                        @error('seo-desc')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input
                                            ...
                                            placeholder="Title"
                                            name="seo_keywords"
                                            value="{{old('seo_keywords',$project->seo_keywords)}}"
                                        />
                                        @error('seo_keywords')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
