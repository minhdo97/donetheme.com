...
<div class="row">
  <div class="col-12">
      <ul class="nav nav-pills mb-2">
          <!-- Account -->
          <li class="nav-item">
              <a class="nav-link " href="{{route('admin.account.settings.account')}}">
...
@include('admin/content/_partials/_modals/modal-pricing')
@include('admin/content/_partials/_modals/modal-edit-cc')
@endsection
