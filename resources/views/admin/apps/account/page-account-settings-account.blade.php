    ...
    <div class="row">
        <div class="col-12">
            <ul class="nav nav-pills mb-2">
                <!-- Account -->
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.account.settings.account')}}">
            ...
            <div class="card">
                ...
                <div class="card-body py-2 my-25">
                    ...
                    <form class="" enctype="multipart/form-data"
                          action="{{route('admin.admins.update',['admin'=>$user->id])}}"
                          method="POST"> @csrf @method('PUT')
                    <!-- header section -->
                        <div class=" mt-2 pt-50d-flex">
                            <a href="#" class="me-25">
                                <img
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 mb-1">
                                ...
                                <select id="roles" name="role" class="select2 form-select">
                                    @foreach($roles as $role)
                                        <option @if($user->getRoleNames()->contains($role->name)) selected
            ...
            <div class="card">
                ...
                <div class="card-body py-2 my-25">
                    ...
                    <form id="formAccountDeactivation" class="validate-form" onsubmit="return false">
                        ...
                        <div>
                            <button type="submit" class="btn btn-danger deactivate-account mt-1">Deactivate Account
                            </button>
                        </div>
                    </form>
                </div>
