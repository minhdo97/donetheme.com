        ...
        @else
                    ...
                    <ul class="nav navbar-nav align-items-center ms-auto">
                        <li class="nav-item dropdown dropdown-language">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                                ...
                                <a class="dropdown-item" href="{{ url('admin/lang/fr') }}" data-language="fr">
                                    <i class="flag-icon flag-icon-fr"></i> French
                                </a>
                                <a class="dropdown-item" href="{{ url('admin/lang/de') }}" data-language="de">
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                                ...
                                <li class="scrollable-container media-list">
                                    <div class="list-item align-items-center">
                                        <img class="d-block rounded me-1"
                                             src="{{ asset('images/pages/eCommerce/1.png') }}" alt="donuts"
                                             width="62">
                                    ...
                                    <div class="list-item align-items-center">
                                        <img class="d-block rounded me-1"
                                             src="{{ asset('images/pages/eCommerce/7.png') }}" alt="donuts"
                                             width="62">
                                        <div class="list-item-body flex-grow-1">
                                            <i class="ficon cart-item-remove" data-feather="x"></i>
                                            <div class="media-heading">
                                    ...
                                    <div class="list-item align-items-center">
                                        <img class="d-block rounded me-1"
                                             src="{{ asset('images/pages/eCommerce/2.png') }}" alt="donuts"
                                             width="62">
                                        <div class="list-item-body flex-grow-1">
                                            <i class="ficon cart-item-remove" data-feather="x"></i>
                                            <div class="media-heading">
                                    ...
                                    <div class="list-item align-items-center">
                                        <img class="d-block rounded me-1"
                                             src="{{ asset('images/pages/eCommerce/3.png') }}" alt="donuts"
                                             width="62">
                                        <div class="list-item-body flex-grow-1">
                                            <i class="ficon cart-item-remove" data-feather="x"></i>
                                            <div class="media-heading">
                                    ...
                                    <div class="list-item align-items-center">
                                        <img class="d-block rounded me-1"
                                             src="{{ asset('images/pages/eCommerce/5.png') }}" alt="donuts"
                                             width="62">
                                        <div class="list-item-body flex-grow-1">
                                            <i class="ficon cart-item-remove" data-feather="x"></i>
                                            <div class="media-heading">
                                ...
                                <li class="dropdown-menu-footer">
                                    ...
                                    <a class="btn btn-primary w-100"
                                       href="{{ url('app/ecommerce/checkout') }}">Checkout</a>
                                </li>
                            </ul>
                        </li>
          ...
          <span class="user-name fw-bolder">
            ...
            Admin
                                ...
                                <span class="avatar">
          <img class="round"
               src="{{ Auth::guard('admin')->check() ? Auth::guard('admin')->user()->getFirstMediaUrl('avatar') : asset('images/portrait/small/avatar-s-11.jpg') }}"
...
{{--                                   href="{{ Route::has('admin.account.settings.profile') ? route('admin.account.settings.profile') : 'javascript:void(0)' }}">--}}
{{--                                    <i class="me-50" data-feather="user"></i> Profile--}}
{{--                                </a>--}}
                                <a class="dropdown-item" href="{{route('admin.account.settings.account')}}">
                                ...
                                @else
                                    <a class="dropdown-item"
                                       href="{{ Route::has('admin.auth.login') ? route('admin.auth.login') : 'javascript:void(0)' }}">
