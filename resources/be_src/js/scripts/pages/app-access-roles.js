$(function () {
    ...
    if (dtUserTable.length) {
        dtUserTable.DataTable({
            ajax: assetPath + 'api/admin/admins', // JSON file to add data
            columns: [
    ...
    roleEditMl.on('show.bs.modal', function (e) {
        let id = $(e.relatedTarget).data('id')
        $.ajax({
            url: assetPath + 'api/admin/roles/' + id,
            type: 'GET',
            data: {},
            success: function (response) {
                editRoleForm.replaceWith(response);
